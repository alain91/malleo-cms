	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		init : function(ed, url) {
			...
			ed.onInit.add(function() {
				...
				ed.dom.loadCSS(ed.baseURI.toAbsolute(path_skin+ ed.settings.skin + "/content.css"));
			});
			...
			DOM.loadCSS(ed.baseURI.toAbsolute(s.editor_css || path_skin+ ed.settings.skin + "/ui.css"));

			if (s.skin_variant)
				DOM.loadCSS(ed.baseURI.toAbsolute(s.editor_css ||path_skin+ ed.settings.skin + "/ui_" + s.skin_variant + ".css"));
		},
