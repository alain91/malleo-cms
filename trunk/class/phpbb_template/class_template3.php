...
*
* modifie pour Malleo CMS par alain91
*
*/
...
class Template3
{
	...
	* @access public
	*/
	function Template3($root='.', $cache='cache')
	{
	...
	*/
	function set_filenames($filename_array)
	{
		...
		foreach ($filename_array as $handle => $filename)
		{
			...
			if (!file_exists($file))
			{
				trigger_error("Template->set_filenames: File $file does not exist", E_USER_ERROR);
			}
			...
			{
				$file = $this->inherit_root . '/' . $filename;
				if (!file_exists($file))
				{
					trigger_error("Template->set_filenames: Inherited File $file does not exist", E_USER_ERROR);
				}
				$this->files_inherit[$handle] = $file$;
			}
		}
	...
	*/
	function _tpl_load(&$handle)
	{
		...
		$compile = new Template3_compile($this);
