...
load_lang_bloc('wiki_nouveau');

if (isset($_POST['creer_tag'])){
	$wiki->clean($_POST);
	header('location: '.formate_url('t='.$wiki->t,true));
	exit;
}

$tpl->set_filenames(array(
	  'wiki_nouveau' => $root.'plugins/blocs/wiki_nouveau/html/bloc_wiki_nouveau.html'
));
