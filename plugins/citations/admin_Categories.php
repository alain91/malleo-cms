...
defined('CITATIONS_PATH') OR define('CITATIONS_PATH', dirname(__FILE__));
...
require(CITATIONS_PATH.'/prerequis.php');
$tpl->set_filenames(array('body_admin' => CITATIONS_PATH.'/html/admin_categories.html'));
...
if (isset($_POST['action']) || isset($_GET['action']))
{
	...
	switch ($action)
	{
		...
		case 'ajouter':
			...
			$sql = 'INSERT INTO '.TABLE_CITATIONS_CATS.' (titre_cat, image_cat) VALUES (
		...
		case 'edit':
			$id_cat = intval($_GET['id_cat']);
			$sql = 'SELECT titre_cat, image_cat FROM '.TABLE_CITATIONS_CATS.' WHERE id_cat = '.$id_cat;
