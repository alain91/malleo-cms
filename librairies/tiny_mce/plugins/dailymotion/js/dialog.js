...
var DailyMotionDialog = {
	...
	insert : function() {
		...
		var embedCode = '[dailymotion width='+document.forms[0].dailymotionWidth.value+' height='+document.forms[0].dailymotionHeight.value+']'+document.forms[0].dailymotionID.value+'[/dailymotion]';
